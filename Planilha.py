...
<style>
@media print {
    /* Oculta painel lateral, cabeçalho e rodapé padrão do Streamlit */
    [data-testid="stSidebar"] { display: none !important; }
    [data-testid="stHeader"] { display: none !important; }
    footer { display: none !important; }
    
    /* Oculta elementos iterativos e botões na hora de imprimir */
    .stButton, .btn-imprimir, .stDownloadButton { display: none !important; }
    
    /* Ajusta a margem para impressão limpa */
    .block-container { padding-top: 0px !important; margin-top: 0px !important; }
    
    /* Força tabelas a ficarem legíveis e na página */
    table { font-size: 11px !important; page-break-inside: auto; }
    tr { page-break-inside: avoid; page-break-after: auto; }
}

/* Estilo do Botão Customizado de Impressão (Ficará bonito na tela) */
.btn-imprimir {
